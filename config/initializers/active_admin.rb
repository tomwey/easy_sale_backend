ActiveAdmin.setup do |config|
  ...
  # config.register_javascript 'http://cdn.staticfile.org/qiniu-js-sdk/1.0.14-beta/qiniu.min.js'
  ...
  # 自定义页脚
  config.footer = "版权所有 #{Date.today.year} Easy sale"
