...
set :application, 'easy_sale_backend'
...
set :linked_files, %w{config/database.yml config/config.yml config/redis.yml config/sidekiq.yml config/private_key.txt config/alipay_public_key.txt} # config/redis.yml
